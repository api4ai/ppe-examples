# API4AI Samples: PPE Monitoring for CCTV

<div align="center">
<a target="_blank" href="https://api4.ai?utm_source=ppe_example_repo&utm_medium=readme&utm_campaign=examples"><img src="https://storage.googleapis.com/api4ai-static/logo/a4a-logo-horizontal-gradient-rectangular-bg-round-glow-small-550.png"/></a>
</div>
...
<a target="_blank" href="https://api4.ai/apis/ppe?utm_source=ppe_example_repo&utm_medium=readme&utm_campaign=examples"><img src="https://img.shields.io/badge/api4.ai%20platform-fee33c?style=for-the-badge&logo=icloud&logoColor=black"/></a>
...
API4AI is cloud-native computer vision & AI platform for startups, enterprises and individual developers. This repository contains sample mini apps that utilize **PPE CCTV API** provided by API4AI.

The Personal Protective Equipment (PPE) Monitoring for CCTV API provides people detection service with consequent checking of wearing different types of personal protective equipment.
...
* Learn more about API on [api4.ai](https://api4.ai/docs/ppe?utm_source=ppe_example_repo&utm_medium=readme&utm_campaign=examples)
